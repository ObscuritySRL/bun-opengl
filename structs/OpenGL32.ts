...
class OpenGL32 {
  /**
   * Lazily binds a single `opengl32.dll` export and memoizes it on the class.
   *
   ...
   */
  private static Load<T extends keyof typeof OpenGL32.Symbols>(method: T): (typeof OpenGL32)[T] {
    ...
    const library = dlopen('opengl32.dll', { [method]: OpenGL32.Symbols[method] });
    const propertyDescriptor = { configurable: false, value: library.symbols[method] } as const;

    Object.defineProperty(OpenGL32, method, propertyDescriptor);

    return OpenGL32[method];
  }

  /**
   * Eagerly binds multiple `opengl32.dll` exports at once.
   *
   ...
   * ```ts
   * // Bind a subset
   * OpenGL32.Preload(['glGetString', 'glClear']);
   *
  ...
  public static Preload(methods?: (keyof typeof OpenGL32.Symbols)[]): void {
    ...
    Object.defineProperties(OpenGL32, propertyDescriptorMap);
